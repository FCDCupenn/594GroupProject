 ...
 * that your submission file is a zip archive and that edu.upenn.cit594.Main.java is in the
...
public class CheckSubmissionZip {
	...
	public static void main(String [] argv) throws Exception {
		...
		if(possible_mains.size() < 1)
			System.out.println("edu.upenn.cit594.Main.java not found in the expected location.");
		else if(possible_mains.size() > 1)
			System.out.println("Multiple edu.upenn.cit594.Main.java candidates discovered, please only submit one source tree");
		else {
			System.out.println("zip archive organization seems correct, edu.upenn.cit594.Main.java found at:\n\t" + possible_mains.get(0));
		}
	}
}
